...
python code/merge_data_run_iterative_plsr.py test/output atm_model_comparisons/am_isofit/CRBU_settings.txt -shade_type dsm -bn False -sn True

# run plotting code to create final output plots
# python code/plot_10fold_plsr_results.py -folds 1 -results_directory test/output
