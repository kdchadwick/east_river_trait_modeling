...
python code/merge_data_run_iterative_plsr.py atm_model_comparisons/am_acorn atm_model_comparisons/am_acorn/CRBU_settings.txt -shade_type dsm -n_folds_to_run 10 -spectra_file data/spectra/acorn_refl_extractions.csv
